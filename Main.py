...
main = tkinter.Tk()
main.title("A Multi-Stream Feature Fusion Approach for Traffic Prediction")
...
font = ('times', 16, 'bold')
title = Label(main, text='                           A Multi-Stream Feature Fusion Approach for Traffic Prediction',anchor=W, justify=CENTER)
